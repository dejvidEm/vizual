...
const TECH_CENTER = portfolioImages[9];
const sideImages = [
  { src: portfolioImages[1].src, alt: portfolioImages[1].alt, position: "left" as const, span: 1 },
  { src: portfolioImages[4].src, alt: portfolioImages[4].alt, position: "left" as const, span: 1 },
  { src: portfolioImages[5].src, alt: portfolioImages[5].alt, position: "right" as const, span: 1 },
  { src: portfolioImages[10].src, alt: portfolioImages[10].alt, position: "right" as const, span: 1 },
];
...
export function TechnologySection() {
  ...
  const descriptionText = "Používam pokročilé AI nástroje a vlastný proces, vďaka ktorému vznikajú produktové fotky, ktoré vyzerajú ako profesionálne nafotené v štúdiu. Tvoj produkt. Nový level prezentácie.";
    ...
    <section id="technology" ref={sectionRef} className="relative bg-foreground">
            ...
            >
              ...
              >
                <h2 className="max-w-3xl font-medium leading-tight tracking-tight text-white md:text-5xl lg:text-7xl text-5xl">
                  {["AI", "vizuály,", "ako z reality."].map((word, index) => {
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-4xl">
          ...
          <h3 className="mb-10 text-center text-2xl font-medium tracking-tight text-foreground md:text-3xl">
            AI vizuály, ktoré nerozoznáš od reality
          </h3>
